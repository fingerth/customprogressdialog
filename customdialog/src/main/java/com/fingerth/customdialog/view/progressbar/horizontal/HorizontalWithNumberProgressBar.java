package com.fingerth.customdialog.view.progressbar.horizontal;
...
public class HorizontalWithNumberProgressBar extends ProgressBar {
    ...
    public void setFAttributes(FAttributes att) {
        mTextColor = att.mTextColor;
        mReachedBarColor = att.mReachedBarColor;
        mUnReachedBarColor = att.mUnReachedBarColor;
    }
     ...
     * size of text (sp)
     */
    protected int mTextSize = Utils.sp2px(getContext(), DEFAULT_TEXT_SIZE);

    /**
     * offset of draw progress
     */
    protected int mTextOffset = Utils.dp2px(getContext(), DEFAULT_SIZE_TEXT_OFFSET);

    /**
     * height of reached progress bar
     */
    protected int mReachedProgressBarHeight = Utils.dp2px(getContext(), DEFAULT_HEIGHT_REACHED_PROGRESS_BAR);
     ...
     */
    protected int mUnReachedProgressBarHeight = Utils.dp2px(getContext(), DEFAULT_HEIGHT_UNREACHED_PROGRESS_BAR);
    /**
