package com.fingerth.customdialog.view.progressbar.round;
...
import com.fingerth.customdialog.view.progressbar.horizontal.HorizontalWithNumberProgressBar;
...
//      <!--注意：當我把長寬寫成90dp時， 為了讓progressbar居中並且全部顯示，這時 radius + progressbar_reached_height 要等于45dp（）-->
     ...
     * mRadius of view
     */
    private int mRadius = Utils.dp2px(getContext(), 30);
